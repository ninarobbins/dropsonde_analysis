...
flight_time = datetime(2024, 8, 13, 15, 0, 0)
...
try:
    tracks = xr.open_dataset('/Volumes/ORCESTRA/'+flight_index+'a/bahamas/QL_'+flight_index+'a_BAHAMAS_V01.nc')
...
issued_time = datetime(2024, 8, 13, 0, 0, 0)
...
# Save
plt.savefig(f"IWV_dropsondes_IFS_PERCUSION_HALO_{flight_time.strftime("%Y%m%d")}.png", bbox_inches="tight")
