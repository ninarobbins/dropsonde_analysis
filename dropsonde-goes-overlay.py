...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 18 11:55:35 2024
...
# path_to_dropsondes = f"/Users/ninarobbins/Desktop/PhD/ORCESTRA/HALO-DATA/{flight_time.strftime("%Y%m%d")}"
...
# dropsonde_ds.to_netcdf(f"/Volumes/Upload/HALO/Dropsonde/{flight_time_str.replace("-", "")}/quickgrid/quickgrid-dropsondes-{flight_time_str.replace("-", "")}.nc")
...
# Save
plt.savefig(f"IWV_QL_dropsondes_PERCUSION_HALO_{flight_time.strftime("%Y%m%d")}.png", bbox_inches="tight")
